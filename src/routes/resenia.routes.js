...
// Nueva ruta para la exportacion del archivo del usuario a una carpeta /exports
routes.get("/usuariodocs/:id", getReseniasByIdUsuarioDocs); // GET Para obtener las Reseñas creadas por el usuario
